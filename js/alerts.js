...
export function buildAlerts(weather, { convertTemp, unit } = {}) {
  if (!weather) return [];
  ...
  // ---- Heat ----
  // Note: alert thresholds stay in °C intentionally — they're physical
  // thresholds, not display values. Only the shown numbers get converted.
